...
const get_teachers = async (req,res) =>{
 ...
 const getNewTeachersSchedule =  async()=> {
     modified = true;
     teachers = JSON.parse(JSON.stringify(teachers_data.teachers)); 
     classes = JSON.parse(JSON.stringify(teachers_data.someclassess));
